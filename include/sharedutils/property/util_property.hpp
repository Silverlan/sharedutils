...
template<class TProperty, class T>
std::shared_ptr<TProperty> util::SimpleProperty<TProperty, T>::Create(const T &value)
{
	return std::make_shared<TProperty>(value);
};

template<class TProperty, class T>
util::SimpleProperty<TProperty, T>::SimpleProperty(const T &init) : BaseProperty(), m_value(init)
{
}

template<class TProperty, class T>
util::SimpleProperty<TProperty, T>::SimpleProperty(const util::SimpleProperty<TProperty, T> &prop) : BaseProperty(), m_value(prop.m_value)
{
}
...
template<class TProperty, class T>
bool util::SimpleProperty<TProperty, T>::IsLocked() const
{
...
template<class TProperty, class T>
util::SimpleProperty<TProperty, T> &util::SimpleProperty<TProperty, T>::operator=(const SimpleProperty<TProperty, T> &other)
{
	return operator=(other.GetValue());
}

template<class TProperty, class T>
bool util::SimpleProperty<TProperty, T>::operator==(const T &val) const
{
	return (GetValue() == val) ? true : false;
}

template<class TProperty, class T>
bool util::SimpleProperty<TProperty, T>::operator==(const SimpleProperty<TProperty, T> &prop) const
{
...
template<class TProperty, class T>
util::SimpleProperty<TProperty, T>::operator const T &() const
{
	return GetValue();
}

template<class TProperty, class T>
util::SimpleProperty<TProperty, T>::operator T &()
{
	return GetValue();
}

template<class TProperty, class T>
T &util::SimpleProperty<TProperty, T>::operator*()
{
	return m_value;
}
template<class TProperty, class T>
const T &util::SimpleProperty<TProperty, T>::operator*() const
{
	return m_value;
}
...
template<class TProperty, class T>
const T &util::SimpleProperty<TProperty, T>::GetValue() const
{
	return m_value;
}

template<class TProperty, class T>
T &util::SimpleProperty<TProperty, T>::GetValue()
{
	return m_value;
}
