...
export {
	...
	namespace util {
		...
		public:
			...
			TMatrixProperty &operator=(const T &val) { return static_cast<TMatrixProperty&>(SimpleProperty<TMatrixProperty, TMatrix>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix2Property &operator=(const T &val) { return static_cast<Matrix2Property&>(SimpleProperty<Matrix2Property, Mat2>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix2x3Property &operator=(const T &val) { return static_cast<Matrix2x3Property&>(SimpleProperty<Matrix2x3Property, Mat2x3>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix2x4Property &operator=(const T &val) { return static_cast<Matrix2x4Property&>(SimpleProperty<Matrix2x4Property, Mat2x4>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix3Property &operator=(const T &val) { return static_cast<Matrix3Property&>(SimpleProperty<Matrix3Property, Mat3>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix3x2Property &operator=(const T &val) { return static_cast<Matrix3x2Property&>(SimpleProperty<Matrix3x2Property, Mat3x2>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix3x4Property &operator=(const T &val) { return static_cast<Matrix3x4Property&>(SimpleProperty<Matrix3x4Property, Mat3x4>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix4x2Property &operator=(const T &val) { return static_cast<Matrix4x2Property&>(SimpleProperty<Matrix4x2Property, Mat4x2>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix4x3Property &operator=(const T &val) { return static_cast<Matrix4x3Property&>(SimpleProperty<Matrix4x3Property, Mat4x3>::operator=(val)); }
		};
		...
		public:
			...
			template<class TProperty, class T>
			Matrix4Property &operator=(const T &val) { return static_cast<Matrix4Property&>(SimpleProperty<Matrix4Property, Mat4>::operator=(val)); }
		};
