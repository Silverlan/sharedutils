...
util::PathIterator<util::Path> util::Path::begin() { return PathIterator {*this, true}; }
util::PathIterator<util::Path> util::Path::end() { return PathIterator {*this, false}; }
util::PathIterator<const util::Path> util::Path::begin() const { return PathIterator {*this, true}; }
util::PathIterator<const util::Path> util::Path::end() const { return PathIterator {*this, false}; }
...
util::PathIterator<TPath>::PathIterator(TPath &path, bool begin) : m_path {&path}, m_pos {begin ? 0 : std::string::npos}
{
