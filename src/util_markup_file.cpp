...
void MarkupFile::IncrementFilePos(uint32_t inc) { m_dataStream->SetOffset(m_dataStream->GetOffset() + inc); }
void MarkupFile::DecrementFilePos(uint32_t dec) { m_dataStream->SetOffset(m_dataStream->GetOffset() - dec); }
