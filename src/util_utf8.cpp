...
Utf8StringView::Utf8StringView(const Utf8String &str)
	: m_string{str}
{}
Utf8StringView::Utf8StringView(const std::string &str)
	: m_string{str}
{}
Utf8StringView::Utf8StringView(const char *str)
	: m_string{str}
{}
...
size_t Utf8StringView::find(const char *str,size_t startPos) const
{
	return m_string.find(str,startPos);
}
size_t Utf8StringView::find(const std::string &str,size_t startPos) const
{
	return m_string.find(str,startPos);
}
size_t Utf8StringView::find(const Utf8String &strU8,size_t startPos) const
{
	return m_string.find(strU8,startPos);
}
uint16_t Utf8StringView::get(size_t idx) const
{
	return m_string.at(idx);
}
Utf8StringIterator Utf8StringView::begin() const
{
	return const_cast<Utf8StringView*>(this)->m_string.begin();
}
Utf8StringIterator Utf8StringView::end() const
{
	return const_cast<Utf8StringView*>(this)->m_string.end();
}
...
{
	return m_string.substr(start,count);
}
