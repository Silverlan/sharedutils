...
static void bake_differentials(
	...
	const util::baking::Uv &uv1,
	const util::baking::Uv &uv2,
	const util::baking::Uv &uv3
)
{
...
static void zspan_scanconvert(
	util::baking::detail::BakeSpanData &zspan,
	util::baking::BakeDataView &handle,
	util::baking::Uv &v1,
	util::baking::Uv &v2,
	util::baking::Uv &v3,
	void (*func)(util::baking::BakeDataView&, int, int, float, float)
)
{
...
void util::baking::prepare_bake_pixel_data(
	BakeDataView &dv,uint32_t objectId,const MeshInterface &meshInterface,uint32_t numTris,
