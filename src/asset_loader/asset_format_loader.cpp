...
std::optional<util::AssetLoadJobId> util::AssetFormatLoader::AddJob(
	const std::string &identifier,const std::string &ext,std::unique_ptr<ufile::IFile> &&file,util::AssetLoadJobPriority priority,
	const std::function<void(util::IAssetProcessor&)> &initProcessor
)
{
